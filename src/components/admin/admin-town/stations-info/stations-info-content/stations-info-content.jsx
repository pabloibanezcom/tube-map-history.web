      ...
      <div className="row mb-20">
        <div className="col-lg-6 col-md-6">
          <h4 className="secondary right-line right-line-secondary mb-20">
            <Translation prefix={i18nPrefix} id="STATION_INFO" />
          </h4>
          <div className="row">
        ...
        <div className="col-lg-6 col-md-6">
          <h4 className="secondary right-line right-line-secondary mb-20">
            <Translation prefix={i18nPrefix} id="CONNECTIONS" />
          </h4>
          {element.connections
            ...
            .map(c => {
              return (
                <div key={c._id}>
                  <div
                    className="d-flex justify-content-between pl-10 mb-5 "
                    style={{
                      borderLeftWidth: 5,
                      borderLeftStyle: 'solid',
                      borderLeftColor: c.line.colour
                    }}
                  >
                    <div>
                      <span className="primary mr-20">{c.year}</span>
                      <span className="mr-20">
                        {c.stations.find(s => s._id !== element._id).name}
                      </span>
                    </div>
                    <div>
