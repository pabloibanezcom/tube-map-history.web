...
const formChanges = props => {
  ...
  const modifiedData = Object.keys(formData)
    .map(key => {
      return { before: initialValues[key], after: formData[key] };
    })
    ...
    <div className="form-changes">
        ...
        <div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <Button color="secondary" inverse block text="Yes" onClick={onGoBack} />
            </div>
            <div className="col-lg-6">
              <Button color="light" text="Cancel" block onClick={onCancel} />
            </div>
          </div>
        </div>
      )}
      {Boolean(modifiedData.length) && (
        <div>
            ...
            {modifiedData.map((md, i) => {
              return (
                <div key={i} className="d-flex justify-content-between align-items-center">
                  ...
                  <Icon name="long-arrow-right" color="secondary" />
          ...
          <div className="row">
            <div className="col-lg-6">
              <Button color="secondary" inverse text="Yes" onClick={onConfirm} />
            </div>
            <div className="col-lg-6">
              <Button color="light" text="No" onClick={onCancel} />
            </div>
          </div>
        </div>
      )}
...
formChanges.propTypes = {
  ...
  nonChangesTitle: PropTypes.oneOfType([PropTypes.string, PropTypes.object]),
