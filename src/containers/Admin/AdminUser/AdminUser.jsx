...
class AdminUser extends React.Component {
  ...
  render() {
    ...
    return <div className="admin-user-container">
        ...
        {user && (
          <div className="row">
            <div className="col-lg-4">
              <div className="card animated fadeInUp animation-delay-7">
                ...
                <div className="card-body pt-4 text-center">
                  ...
                  <a className="btn-circle btn-circle-raised btn-circle-xs mt-1 mr-1 no-mr-md btn-facebook"><i className="zmdi zmdi-facebook"></i></a>
                  <a className="btn-circle btn-circle-raised btn-circle-xs mt-1 mr-1 no-mr-md btn-twitter"><i className="zmdi zmdi-twitter"></i></a>
                  <a className="btn-circle btn-circle-raised btn-circle-xs mt-1 mr-1 no-mr-md btn-instagram"><i className="zmdi zmdi-instagram"></i></a>
                </div>
                <div>
                  <CountrySelector
            ...
            <div className="col-lg-8">
              <CollapseList
                type="secondary"
                elements={towns.filter(town => townInUser(town, user))}
                header="town"
                content="town"
