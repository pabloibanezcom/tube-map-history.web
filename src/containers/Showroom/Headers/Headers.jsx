...
const headers = () => {
  return (
    <div className="showroom-headers">
      ...
      <h1 className="primary right-line right-line-secondary mb-20">This is a primary header H1 with secondary right line</h1>
      <h1 className="secondary right-line mb-20">This is a secondary header H1</h1>
      <h1 className="secondary right-line right-line-primary mb-20">This is a secondary header H1 with primary right line</h1>
